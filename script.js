    ...
    thumbnails12.forEach(thumb => {
        thumb.addEventListener('click', function(){
            ...
            main_img12.src = this.src
              ...
              const main_img13 = document.querySelector('.main_img13')
    const thumbnails13 = document.querySelectorAll('.thumbnail13')
    
    
    thumbnails13.forEach(thumb => {
        thumb.addEventListener('click', function(){
            const active13 = document.querySelector('.active13')
            active13.classList.remove('active13')
            this.classList.add('active13')
            main_img13.src = this.src
        })
      })
